...
void display(void)
{
	...
	glTranslatef (0.35, 2.2, -0.2);//translate objeto
	//glTranslatef (0.0, 0.2, 0.0);//translate transformacao
	glPushMatrix();
	glRotatef(-90.0f, 1.0f, 0.0f, 0.0f);
	//glRotatef(60.0f, 0.0f, 1.0f, 0.0f);
	//glRotatef(60.0f, 0.0f, 0.0f, 1.0f);
	gluCylinder(obj, 0.1, 0.1, 1.0, 30, 30);
	glPopMatrix();

	glTranslatef (-0.7, 0.0, 0.0);//translate objeto
	//glTranslatef (0.0, 0.2, 0.0);//translate transformacao
	glPushMatrix();
	glRotatef(-90.0f, 1.0f, 0.0f, 0.0f);
	//glRotatef(-60.0f, 0.0f, 1.0f, 0.0f);
	...
	glTranslatef (0.4, 0.0, 0.6);//translate objeto
	//glTranslatef (0.0, 0.2, 0.0);//translate transformacao
	glPushMatrix();
	glRotatef(-90.0f, 1.0f, 0.0f, 0.0f);
	//glRotatef(-60.0f, 0.0f, 1.0f, 0.0f);
